...
if (isModEnabled('expedition')) {
	...
	$rowspan++;
	$sectionauto[] = array('level'=>1, 'module'=>'expedition', 'test'=>isModEnabled('expedition'), 'label'=>$langs->trans("Shipments"), 'desc'=>$langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Shipments")));
}
